...
import sdk.event.BroadcastIsBufferingEvent;
import sdk.event.HlsManifestWrittenEvent;
import sdk.event.HlsSegmentWrittenEvent;
import sdk.event.MuxerFinishedEvent;
import sdk.event.S3UploadEvent;
import sdk.event.StreamLocationAddedEvent;
import sdk.event.ThumbnailWrittenEvent;

import static sdk.Kickflip.isKitKat;
...
//    }
     ...
     */
    @Override
    public void startRecording(String slug) {
        super.startRecording(slug);

        HlsStream stream = new HlsStream();
        stream.slug = slug;
        onGotStreamResponse(stream);
...
//        FileUploadService.uploadVideoSegment(this);
...
//            mKickflip.setStreamInfo(mStream, null);
     ...
     */
    public void submitQueuedUploadsToS3() {
