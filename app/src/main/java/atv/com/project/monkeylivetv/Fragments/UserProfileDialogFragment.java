...
//        mHandleTv.setText(currentUser.message.userHandle);
        ...
        if(currentUser.message.userId == MonkeyLive.loggedInUserId){
    ...
    private void initialiseView() {
        ...
        mUserNameTv.setTypeface(MonkeyLive.racho);
