...
import atv.com.project.monkeylivetv.Adapters.StreamFeedAdapter;
...
import atv.com.project.monkeylivetv.Pojo.StreamFeedDetails;
import atv.com.project.monkeylivetv.lib.FeedCard;
...
//                super.onPreExecute();
    ...
    private void sendRegistrationIdToServer() {
        ...
        new MyHttp<MyResponse>(getActivity(), EndPoints.updateUser(MonkeyLive.loggedInUserId), MyHttp.PUT, MyResponse.class)
                .defaultHeaders()
    ...
    private void storeRegistrationId(){
        MonkeyLive.setStringPreferenceData(MonkeyLive.PROPERTY_REG_ID, regId);
    }
    private String getRegistrationId() {
        String registrationId = MonkeyLive.getStringPreference(MonkeyLive.PROPERTY_REG_ID, "");
                ...
                public void onClick(Card card, View view) {
                    if (currentFeed.state.equalsIgnoreCase("scheduled")) {
                        ...
                        builder.setTitle("Scheduled Stream")
                                .setMessage("The stream is scheduled " + MonkeyLive.timeElapsedAsRelativeTime(currentFeed.startTime))
...
//                        VideoPlayerActivity.start(getActivity(), currentFeed.url, true, currentFeed.slug);
    ...
    private void registerScoreUpdateReceiver() {
        ...
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(scoreUpdateReceiver, new IntentFilter(MonkeyLive.SCORE_UPDATED));
    }
...
//        }
        ...
        noStreamTv.setTypeface(MonkeyLive.racho);
