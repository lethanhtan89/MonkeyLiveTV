...
public class MainActivityVideoStreamConnected extends Activity implements RtspClient.Callback,
        Session.Callback, SurfaceHolder.Callback {
        // log tag
        public final static String TAG = MainActivityVideoStreamConnected.class.getSimpleName();
        ...
        private ImageView camera_led, camera_type, camera_settings, camera_option, camera_chat;
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.activity_videostream_connected);
                ...
                camera_chat = (ImageView) findViewById(R.id.pop_camera_chat);
        ...
        private void alertError(final String msg) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityVideoStreamConnected.this);
