...
import atv.com.project.popkontv.Services.LocationServices;

/**
 * Created by arjun on 5/7/15.
 */
public class Viewora extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        Viewora.context = getApplicationContext();
        updateGlobalData();
        initFonts();
    ...
    public static void clearSharedPreferences(){
        setIntPreferenceData(Viewora.USER_ID, 0);
        setStringPreferenceData(Viewora.PROPERTY_REG_ID, "");
        setBooleanPreferenceData(Viewora.USER_ONBOARDING, true);
