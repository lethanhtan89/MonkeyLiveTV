 ...
 */
public class Popkon extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        Popkon.context = getApplicationContext();
        updateGlobalData();
        initFonts();
    ...
    public static void clearSharedPreferences(){
        setIntPreferenceData(Popkon.USER_ID, 0);
        setStringPreferenceData(Popkon.PROPERTY_REG_ID, "");
        setBooleanPreferenceData(Popkon.USER_ONBOARDING, true);
